...
version 1.1
	...
	* Fixed browser bug
		- the code waas only working on windows.
			Now works on mac and linux(linux not perfect, since I need to know which browser the end-user is using)
			
	* Added a feature to show a dialog message to the end- user when they are shutting down/ logging off their computer
	    - 
##################
...
public class usbReminder extends JFrame{
	...
	public static void main (String[] args){
	 ...
	 Runtime.getRuntime().addShutdownHook(new Thread(new Runnable()  {
      public void run() {
		//JOptionPane.showMessageDialog(null,"Hey! Don't forget to take your usb before u go!!!"," Wait!!! ",JOptionPane.WARNING_MESSAGE);
        
				/* JOptionPane pane = new JOptionPane("Hey! Don't forget to take your usb before you go!!!",JOptionPane.WARNING_MESSAGE);
				JDialog dialog = pane.createDialog(" Wait! ");
				dialog.setAlwaysOnTop(true);
				dialog.setVisible(true);*/
